  ...
  return (
    <div className="pm-page pm-product-page">
      ...
      <section className="pm-section pm-ai-deep">
        ...
        <div className="pm-ai-layout"><div className="pm-image-card proxoai-console-card"><img src="/images/proxoai-report-console.png" alt="ProxoPACS reporting console powered by ProxoAI" /></div><div className="pm-grid cols-3">{aiGroups.map(([title, items]) => <article className="pm-card" key={title as string}><h3>{title}</h3><FeatureList items={items as string[]} /></article>)}</div></div>
